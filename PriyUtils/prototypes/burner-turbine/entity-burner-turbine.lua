...
local layers = {
  ...
  {
    {
      filename = "__PriyUtils__/graphics/entity/burner-turbine/burner-turbine.png",
      priority = "extra-high",
      line_length = 4,
      frame_count = 8,
      animation_speed = 0.5,
    ...
    {
      filename = "__PriyUtils__/graphics/entity/burner-turbine/burner-turbine-shadow.png",
      priority = "extra-high",
      width = 165*2,
      height = 75*2,
      scale = 0.5,
...
local fire_glow = {
  filename = "__PriyUtils__/graphics/entity/burner-turbine/burner-turbine-glow.png",
  priority = "extra-high",
  line_length = 4,
  frame_count = 8,
  animation_speed = 1,
...
local fire_light = {
  filename = "__PriyUtils__/graphics/entity/burner-turbine/burner-turbine-light.png",
  priority = "extra-high",
  line_length = 4,
  frame_count = 8,
  animation_speed = 1,
