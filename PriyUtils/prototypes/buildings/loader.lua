...
data:extend({
  {
    ...
    results = { { type = "item", name = "priy-loader", amount = 1 } },
  },
  {
    type = "item",
    name = "priy-loader",
    ...
    subgroup = "belt",
    order = "d[loader]-a1[priy-loader]",
    place_result = "priy-loader",
    stack_size = 50,
  },
  {
    type = "loader-1x1",
    ...
    minable = { mining_time = 0.25, result = "priy-loader" },
    placeable_by = { item = "priy-loader", count = 1 },
