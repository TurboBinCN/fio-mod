data:extend({
  ...
  },
  {
    ...
    structure = {
      north = {
        filename = "__PriyUtils__/graphics/buildings/superior-splitter/superior-splitter-north.png",
        frame_count = 32,
        line_length = 8,
        priority = "extra-high",
        width = 160,
      ...
      east = {
        filename = "__PriyUtils__/graphics/buildings/superior-splitter/superior-splitter-east.png",
        frame_count = 32,
        line_length = 8,
        priority = "extra-high",
        width = 90,
      ...
      south = {
        filename = "__PriyUtils__/graphics/buildings/superior-splitter/superior-splitter-south.png",
        frame_count = 32,
        line_length = 8,
        priority = "extra-high",
        width = 164,
      ...
      west = {
        filename = "__PriyUtils__/graphics/buildings/superior-splitter/superior-splitter-west.png",
        frame_count = 32,
        line_length = 8,
        priority = "extra-high",
        width = 90,
    ...
    structure_patch = {
      ...
      east = {
        filename = "__PriyUtils__/graphics/buildings/superior-splitter/superior-splitter-east-top_patch.png",
        frame_count = 32,
        line_length = 8,
        priority = "extra-high",
        width = 90,
      ...
      west = {
        filename = "__PriyUtils__/graphics/buildings/superior-splitter/superior-splitter-west-top_patch.png",
        frame_count = 32,
        line_length = 8,
        priority = "extra-high",
        width = 90,
