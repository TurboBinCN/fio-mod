...
-- Increase GUI width so that all items groups fit in one row
...
data:extend({
  ...
  {
    type = "item-subgroup",
    name = "delivery-cannon-logistics",
    group = "space",
    order = "b"
  },
  {
  ...
  {
    type = "item-subgroup",
    name = "composite-entity-parts",
    group = "other",
    order = "f"
  },
  {
    type = "item-subgroup",
    name = "interburbulator-parts",
    group = "other",
    order = "g"
  },
  {
    type = "item-subgroup",
    name = "cartouche-parts",
    group = "se-spoilers",
    order = "a"
  },
  {
