...
data:extend{
  {
      ...
      localised_name = {"space-exploration."..data_util.mod_prefix.."struct-generic-settings"},
  ...
  },
  {
      ...
      localised_name = {"space-exploration."..data_util.mod_prefix.."struct-generic-input"},
  ...
  },
  {
      ...
      localised_name = {"space-exploration."..data_util.mod_prefix.."struct-generic-output"},
  ...
  },
  {
      ...
      localised_name = {"space-exploration."..data_util.mod_prefix.."struct-generic-clamp-west"},
      icon = "__space-exploration-graphics__/graphics/icons/settings.png",
      icon_size = 64,
      flags = {},
      hidden = true,
  ...
  },
  {
    ...
    localised_name = {"space-exploration."..data_util.mod_prefix.."struct-generic-clamp-east"},
    icon = "__space-exploration-graphics__/graphics/icons/settings.png",
    icon_size = 64,
    flags = {},
    hidden = true,
