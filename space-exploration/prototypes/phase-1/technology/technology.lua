...
---@param insights string String containing any of the basic insights. a=astrometric, b=biological, s=energy, m=material
...
data:extend({
  ...
  {
    type = "technology",
    name = data_util.mod_prefix .. "always-researched",
    effects = {
     {type = "cargo-landing-pad-count", modifier = 999999, icon = "__base__/graphics/icons/cargo-landing-pad.png", icon_size = 64},
     {type = "deconstruction-time-to-live", modifier = math.pow(2, 32) - 1},
    },
    icons = {
      {icon_size = 256, icon = "__base__/graphics/technology/toolbelt.png"},
      {icon_size = 256, icon = "__space-exploration-graphics__/graphics/technology/space-capsule-navigation.png", scale = 0.4, shift = {2.5, -10}, floating = true},
    },
  ...
  },
  {
    ...
    effects = {
      {
        type = "unlock-recipe",
        recipe = data_util.mod_prefix .. "core-miner-drill",
      },
      {
        type = "unlock-recipe",
  ...
  },
  {
    ...
    icons = {
      { icon = "__base__/graphics/technology/processing-unit.png", scale = 1, icon_size = 256, shift = {12, 12} },
  ...
  },
  {
    ...
    effects = {
      {type = "unlock-recipe", recipe = data_util.mod_prefix .. "water-ice"},
  ...
  },
  {
    ...
    effects = {
      {type = "unlock-recipe", recipe = data_util.mod_prefix .. "methane-ice"},
      {type = "unlock-recipe", recipe = data_util.mod_prefix .. "methane-gas"},
  ...
  --[[{
    ...
    effects = {
     ...
     { type = "unlock-recipe", recipe = data_util.mod_prefix .. "cargo-rocket-section-packed", },
  ...
  },
  {
     ...
     icons = data_util.technology_icon_constant_equipment("__base__/graphics/technology/fission-reactor-equipment.png", 256),
     order = "g-b-z",
     prerequisites = {
  ...
  },
  {
     ...
     effects = {
       { type = "unlock-recipe", recipe = data_util.mod_prefix .."fusion-reactor-equipment" },
     },
     icons = data_util.technology_icon_constant_equipment("__space-exploration-graphics__/graphics/technology/fusion-reactor-equipment.png", 256),
     order = "g-b-z",
     prerequisites = {
  ...
  },
  {
     ...
     effects = {
       { type = "unlock-recipe", recipe = data_util.mod_prefix .."antimatter-reactor-equipment" },
     },
     icons = data_util.technology_icon_constant_equipment("__space-exploration-graphics__/graphics/technology/antimatter-reactor-equipment.png", 256),
     order = "g-b-z",
     prerequisites = {
       data_util.mod_prefix .. "fusion-reactor-equipment",
       data_util.mod_prefix .. "deep-space-science-pack-2",
       data_util.mod_prefix .. "antimatter-reactor",
     },
     type = "technology",
     unit = {
       count = 200,
...

  {
    ...
    effects = {
      ...
      { type = "unlock-recipe", recipe = data_util.mod_prefix .. "astrometric-data" },
...
--[[
...

  {
    ...
    effects = {
      ...
      {
        type = "unlock-recipe",
        recipe = data_util.mod_prefix .. "space-coolant-hot-cryonite",
      }
    },
    icon = "__space-exploration-graphics__/graphics/technology/hypercooler.png",
    icon_size = 128,
...

  {
    ...
    effects = {
      ...
      { type = "unlock-recipe", recipe = data_util.mod_prefix .. "lifesupport-canister" },
...

  {
...

    {
      ...
      effects = {
        {
          type = "unlock-recipe",
          recipe = data_util.mod_prefix .. "space-coolant-hot",
        },
        {
          type = "unlock-recipe",
        ...
        {
          type = "unlock-recipe",
          recipe = data_util.mod_prefix .. "space-coolant-warm",
        },
      },
...

    {
      ...
      effects = {
        ...
        { type = "unlock-recipe",   recipe = data_util.mod_prefix .. "scrap-hard-recycling" },
        { type = "unlock-recipe",   recipe = data_util.mod_prefix .. "broken-data-scrapping" },
        { type = "unlock-recipe",   recipe = data_util.mod_prefix .. "barrel-reprocessing" },
    ...
    },
    {
      ...
      icons = add_insights_to_tech_icon("__space-exploration-graphics__/graphics/technology/supercomputer-1.png", "bs"),
      icon_size = 128,
      order = "e-g",
      prerequisites = {
        data_util.mod_prefix .. "biological-science-pack-1",
    ...
    },
    {
      ...
      icons = add_insights_to_tech_icon("__space-exploration-graphics__/graphics/technology/supercomputer-1.png", "abs"),
      icon_size = 128,
      order = "e-g",
      prerequisites = {
        data_util.mod_prefix .. "space-simulation-ab",
    ...
    },
    {
      ...
      icons = add_insights_to_tech_icon("__space-exploration-graphics__/graphics/technology/supercomputer-1.png", "bsm"),
      icon_size = 128,
      order = "e-g",
      prerequisites = {
        data_util.mod_prefix .. "space-simulation-bm",
    ...
    },
    {
      ...
      icons = add_insights_to_tech_icon("__space-exploration-graphics__/graphics/technology/supercomputer-2.png", "absm"),
      icon_size = 128,
      order = "e-g",
      prerequisites = {
       ...
       effects = {
         { type = "nothing", effect_description={
          "modifier-description." .. data_util.mod_prefix .. "unlock-spaceship-victory",
           tostring(Shared.spaceship_victory_speed),
           tostring(Shared.spaceship_victory_duration),
           tostring(Shared.spaceship_victory_size)
         } },
