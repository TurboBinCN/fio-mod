...
local launch_pad_collision_box = {{-4.65, -4.65}, {4.65, 4.65}}
...
local tank_connector = {
  sprites = tank_connection_sprites,
  points = tank_connection_point,
}
...
data:extend({
  {
      ...
      icon_size = 64,
      icon_draw_specification = { shift = {0, -0.7}, scale = 3, scale_for_many = 2.5 },
  ...
  },
  {
      ...
      icons = data_util.add_icons(
        "__space-exploration-graphics__/graphics/icons/rocket-launch-pad.png",
  ...
  { -- invisibly dummy vehicle
    -- allows player to enter and go with a rocket
      ...
      hidden = true,
      collision_mask = {layers={}},
      collision_box = { { -0.05, -0.4 }, { 0.05, 0.4 } },
      ...
      flags = { "placeable-neutral", "player-creation", "placeable-off-grid", "no-automated-item-insertion", "no-automated-item-removal" },
      friction = 0.9,
      icons = data_util.add_icons(
        "__space-exploration-graphics__/graphics/icons/rocket-launch-pad.png",
  ...
  },
  {
    ...
    fluid_box =
    {
      volume = Shared.cargo_rocket_launch_pad_tank_nonbuffer + Shared.cargo_rocket_launch_pad_tank_buffer,
      pipe_covers = pipecoverspictures(),
      pipe_connections =
      {
        { position = {-4.5,  3.5-1}, direction = defines.direction.west },
        { position = {-4.5, -3.5-1}, direction = defines.direction.west },
        { position = { 3.5, -4.5-1}, direction = defines.direction.north },
        { position = {-3.5, -4.5-1}, direction = defines.direction.north },
        { position = { 4.5,  3.5-1}, direction = defines.direction.east },
        { position = { 4.5, -3.5-1}, direction = defines.direction.east },
        { position = { 3.5,  4.5-1}, direction = defines.direction.south },
        { position = {-3.5,  4.5-1}, direction = defines.direction.south },
      },
    },
    ...
    circuit_connector = {
      tank_connector,  tank_connector,  tank_connector,  tank_connector,
    },
...

  {
    ...
    door_back_sprite =
    {
      ...
      width = 312,
      height = 286,
      shift = util.by_pixel(28.5, 4 + silo_offset_px),
      scale = 0.5
    },
    ...
    door_front_sprite =
    {
      ...
      width = 332,
      height = 300,
      shift = util.by_pixel(-34.5, 24.5 + silo_offset_px),
      scale = 0.5
    },
    ...
    arm_01_back_animation =
    {
      ...
      line_length = 32,
      animation_speed = 0.3,
      shift = util.by_pixel(-53.5, -84 + silo_offset_px),
      scale = 0.5
    },
    ...
    arm_03_front_animation =
    {
      ...
      line_length = 32,
      animation_speed = 0.3,
      shift = util.by_pixel(-50.5, 15.5 + silo_offset_px),
      scale = 0.5
    },
