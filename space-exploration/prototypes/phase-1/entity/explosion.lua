...
make_explosion(1, "small-explosion", {
  filename = "__space-exploration-graphics__/graphics/entity/medium-explosion/medium-explosion.png",
  width = 112,
  height = 94,
  line_length = 6,
  frame_count = 54,
...
make_explosion(4, "huge-explosion", {
  animation_speed = 0.5,
  filename = "__base__/graphics/entity/bigass-explosion/bigass-explosion-36f.png",
  frame_count = 36,
  width = 324,
  height = 416,
  shift = { 0, -1.5 },
  stripes = {
    { filename = "__base__/graphics/entity/bigass-explosion/bigass-explosion-36f-1.png", height_in_frames = 3, width_in_frames = 6 },
    { filename = "__base__/graphics/entity/bigass-explosion/bigass-explosion-36f-2.png", height_in_frames = 3, width_in_frames = 6 }
  },
  scale = 1,
}, {
