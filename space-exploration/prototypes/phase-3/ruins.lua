...
for _, wall_name in pairs({"stone-wall", "concrete-wall", "steel-wall"}) do
  ...
  --wall.collision_mask = collision_mask_util.get_mask(wall)
  --wall.collision_mask.layers[spaceship_collision_layer] = true -- block from spaceship
  wall.hidden = true
...
for _, decal_name in pairs({"sand-decal", "sand-decal-black", "sand-decal-tan", "sand-decal-white",
"sand-decal-black", "light-mud-decal", "dark-mud-decal", "cracked-mud-decal",
"red-desert-decal", "shroom-decal", "lichen-decal", "enemy-decal"}) do
  data:extend({{
    type = "simple-entity",
...
data:extend({
  {
    ...
    inventory_size = 20,
    impact_category = table.deepcopy(data.raw.container["wooden-chest"].impact_category),
    picture =
    {
      layers =
      {
        {
          filename = "__space-exploration-graphics__/graphics/entity/ruins/iron-wood-chest.png",
          priority = "extra-high",
          width = 66,
          height = 76,
  ...
  },
  {
    ...
    picture = {
        filename = "__space-exploration-graphics__/graphics/entity/ruins/iron-wood-chest-remnant.png",
        line_length = 1,
        width = 126,
        height = 78,
        frame_count = 1,
  ...
  },
  {
    ...
    localised_name = {"entity-name.wood-half-chest"},
    ...
    final_render_layer = "remnants",
    picture = {
        filename = "__space-exploration-graphics__/graphics/entity/ruins/wood-half-chest-left.png",
        line_length = 1,
        width = 110,
        height = 73,
        frame_count = 1,
  ...
  },
  {
    ...
    final_render_layer = "remnants",
    picture = {
        filename = "__space-exploration-graphics__/graphics/entity/ruins/wood-half-chest-right.png",
        line_length = 1,
        width = 110,
        height = 73,
        frame_count = 1,
  ...
  },
  {
    ...
    final_render_layer = "remnants",
    picture = {
        filename = "__space-exploration-graphics__/graphics/entity/ruins/vase.png",
        line_length = 1,
        width = 32,
        height = 68,
        frame_count = 1,
  ...
  },
  {
    ...
    final_render_layer = "remnants",
    picture = {
        filename = "__space-exploration-graphics__/graphics/entity/ruins/wooden-barrel.png",
        line_length = 1,
        width = 52,
        height = 86,
        frame_count = 1,
  ...
  },
  {
    ...
    final_render_layer = "remnants",
    picture = {
        filename = "__space-exploration-graphics__/graphics/entity/ruins/furnace-ruin.png",
        line_length = 1,
        width = 128,
        height = 128,
        frame_count = 1,
  ...
  },
  {
    ...
    final_render_layer = "remnants",
    picture = {
        filename = "__space-exploration-graphics__/graphics/entity/ruins/workshop.png",
        line_length = 1,
        width = 255,
        height = 228,
        frame_count = 1,
  ...
  },
  {
    ...
    final_render_layer = "remnants",
    pictures = {
        filename = "__space-exploration-graphics__/graphics/entity/ruins/stone-rubble.png",
        line_length = 1,
        width = 118,
        height = 912/8,
        frame_count = 1,
